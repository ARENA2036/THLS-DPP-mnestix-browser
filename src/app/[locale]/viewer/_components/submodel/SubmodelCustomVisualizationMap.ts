...
import { MaterialCompositionDetail } from './material-composition/MaterialCompositionDetail';
...
export const submodelCustomVisualizationMap = {
    ...
    [SubmodelSemanticIdEnum.MaterialComposition]: MaterialCompositionDetail,
};

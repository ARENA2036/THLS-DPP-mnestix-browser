    ...
    const renderTree = (tree: SubmodelViewObject) => {
        return (
            <EntityTreeItem
                ...
                // Temp workaround that hides the bulk count if it is 0, since currently the AAS Generator can't filter entries out that were generated by a CollectionMappingInfo.
